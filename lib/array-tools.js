...
ArrayTools.exchangeFields = exchangeFields
...
;['pluck', 'pick', 'arrayify', 'where', 'without', 'unique', 'spliceWhile', 'extract', 'flatten', 'sortBy', 'intersect'].forEach(function (method) {
  ArrayTools.prototype[method] = function () {
...
function exchangeFields(a,fieldDictionary) {
  for (var i in a) {
