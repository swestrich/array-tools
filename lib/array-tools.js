...
ArrayTools.groupByAsObject = groupByAsObject
...
ArrayTools.formatFieldValues = formatFieldValues
ArrayTools.onlyKeepFields = onlyKeepFields
...
ArrayTools.groupByAggregate = groupByAggregate;
...
;
['shuffle', 'pluck', 'pick', 'pickNull', 'pickFirst', 'arrayify', 'where', 'without', 'unique', 'uniqueObjects', 'spliceWhile', 'extract', 'flatten', 'sortBy', 'intersect', 'removeFields', 'renameFields', 'formatFieldValues', 'onlyKeepFields', 'merge', 'values', 'groupFields'].forEach(function(method) {
  ArrayTools.prototype[method] = function() {
...
;
['exists', 'findWhere', 'last', 'remove', 'contains', 'equal', 'sameElements', 'groupBy', 'groupByAsObject', 'clone'].forEach(function(method) {
  ArrayTools.prototype[method] = function() {
    var args = arrayify(arguments)
    var endValue = this.val()
