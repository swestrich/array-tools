...
;
['pluck', 'pick', 'arrayify', 'where', 'without', 'unique', 'spliceWhile', 'extract', 'flatten', 'sortBy', 'intersect', 'removeFields', 'renameFields', 'merge', 'values'].forEach(function(method) {
  ArrayTools.prototype[method] = function() {
...
;
['exists', 'findWhere', 'last', 'remove', 'contains', 'equal', 'sameElements','groupBy'].forEach(function(method) {
  ArrayTools.prototype[method] = function() {
    var args = arrayify(arguments)
    var endValue = this.val()
