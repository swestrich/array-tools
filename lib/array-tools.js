...
;
['pluck', 'pick', 'arrayify', 'where', 'without', 'unique', 'spliceWhile', 'extract', 'flatten', 'sortBy', 'intersect', 'removeFields','keepFields', 'renameFields','merge'].forEach(function(method) {
  ArrayTools.prototype[method] = function() {
