...
;
['shuffle','pluck', 'pick', 'pickNull','pickFirst', 'arrayify', 'where', 'without', 'unique', 'uniqueObjects', 'spliceWhile', 'extract', 'flatten', 'sortBy', 'intersect', 'removeFields', 'renameFields', 'merge', 'values', 'groupFields'].forEach(function(method) {
  ArrayTools.prototype[method] = function() {
...
function groupByAsObject(arr, field) {
