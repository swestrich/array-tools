...
;
['shuffle', 'pluck', 'pick', 'pickNull', 'pickFirst', 'arrayify', 'where', 'without', 'unique', 'uniqueObjects', 'spliceWhile', 'extract', 'flatten', 'sortBy', 'intersect', 'removeFields', 'renameFields', 'keepFields', 'merge', 'values', 'groupFields'].forEach(function(method) {
  ArrayTools.prototype[method] = function() {
