...
;
['pluck', 'pick','pickNull', 'arrayify', 'where', 'without', 'unique', 'spliceWhile', 'extract', 'flatten', 'sortBy', 'intersect', 'removeFields', 'renameFields', 'merge', 'values'].forEach(function(method) {
  ArrayTools.prototype[method] = function() {
